<template>
	<view class="release">
		<u-form :model="form" ref="uForm" label-width="200" label-align="center">
			...
			<u-form-item label="招聘人数" prop="user">
				<u-input v-model="form.people_nums" placeholder="请输入招聘人数/人" />
			</u-form-item>
			...
			<u-form-item label="学历要求">
				<u-input v-model="form.school" disabled @click="showSchool = true" placeholder="请选择学历要求" />
			</u-form-item>
			...
			<u-form-item>
				<view style="padding-left: 30rpx;">职位描述</view>
