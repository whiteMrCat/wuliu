<template>
	<view>
		<view class="info-title">{{info.goods_name}}</view>
		<view class="info-list">
			<view class="info-left">始发地</view>
			<view class="info-right">{{info.startAddress}}</view>
		</view>
		<view class="info-list">
			<view class="info-left">目的地</view>
			<view class="info-right">{{info.endAddress}}</view>
		</view>
		<view class="info-list">
		...
		<view class="info-list">
			<view class="info-left">货物重量</view>
			<view class="info-right">{{info.weight}}吨</view>
		</view>
		<view class="info-list">
		...
		<view class="info-list">
			<view class="info-left">货物类型</view>
			<view class="info-right">{{info.goods_type}}</view>
		</view>
